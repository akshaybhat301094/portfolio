  ...
  return (
    <main className="min-h-screen bg-black text-white selection:bg-[#5606ff] selection:text-white p-8 md:p-24 overflow-hidden relative">
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-y-12 md:gap-x-12 items-start mt-12 relative z-10 animate-fade-up">
          
          {/* Profile Picture Section (Order 1 on Mobile) */}
          <div className="col-span-1 md:col-span-2 md:col-start-1 md:row-start-1 order-1 flex flex-col items-center w-full">
            <div className="relative w-64 h-64 md:w-80 md:h-80 rounded-2xl overflow-hidden border border-white/20 shadow-[0_0_40px_rgba(86,6,255,0.4)] bg-zinc-900/80 backdrop-blur-sm">
              <Image 
                src="/akshay.webp" 
                alt="Akshay Bhat" 
                fill 
          ...
          {/* Quick Facts Section (Order 3 on Mobile) */}
          <div className="col-span-1 md:col-span-2 md:col-start-1 md:row-start-2 order-3 flex flex-col items-center w-full">
            <div 
              className="relative p-[1px] rounded-xl transition-all duration-300 hover:-translate-y-1 focus:-translate-y-1 hover:shadow-[0_15px_40px_rgba(86,6,255,0.12)] focus:shadow-[0_15px_40px_rgba(86,6,255,0.12)] z-10 group/facts w-full cursor-pointer focus:outline-none"
              tabIndex={0}
            >
              {/* Default border */}
              <div className="absolute inset-0 rounded-xl border border-white/10 group-hover/facts:opacity-0 group-focus/facts:opacity-0 transition-opacity duration-300" />
              
              {/* Animated gradient background */}
              <div className="absolute inset-0 rounded-xl bg-[linear-gradient(90deg,transparent,rgba(86,6,255,0.4),rgba(254,137,137,0.4),transparent)] bg-[length:200%_100%] animate-border-flow opacity-0 group-hover/facts:opacity-100 group-focus/facts:opacity-100 transition-opacity duration-500" />
              
              {/* Inner Card Content */}
              <div className="relative bg-zinc-900/60 backdrop-blur-md rounded-xl p-6 w-full shadow-xl">
          ...
          {/* Awards Section (Order 4 on Mobile) */}
          <div className="col-span-1 md:col-span-2 md:col-start-1 md:row-start-3 order-4 flex flex-col items-center w-full">
            <div 
              className="relative p-[1px] rounded-xl transition-all duration-300 hover:-translate-y-1 focus:-translate-y-1 hover:shadow-[0_15px_40px_rgba(86,6,255,0.12)] focus:shadow-[0_15px_40px_rgba(86,6,255,0.12)] z-10 group/awards w-full cursor-pointer focus:outline-none"
              tabIndex={0}
            >
              {/* Default border */}
              <div className="absolute inset-0 rounded-xl border border-white/10 group-hover/awards:opacity-0 group-focus/awards:opacity-0 transition-opacity duration-300" />
              
              {/* Animated gradient background */}
              <div className="absolute inset-0 rounded-xl bg-[linear-gradient(90deg,transparent,rgba(86,6,255,0.4),rgba(254,137,137,0.4),transparent)] bg-[length:200%_100%] animate-border-flow opacity-0 group-hover/awards:opacity-100 group-focus/awards:opacity-100 transition-opacity duration-500" />
          ...
          {/* Socials Section (Order 5 on Mobile) */}
          <div className="col-span-1 md:col-span-2 md:col-start-1 md:row-start-4 order-5 flex flex-col items-center w-full">
            <div 
              className="relative p-[1px] rounded-xl transition-all duration-300 hover:-translate-y-1 focus:-translate-y-1 hover:shadow-[0_15px_40px_rgba(86,6,255,0.12)] focus:shadow-[0_15px_40px_rgba(86,6,255,0.12)] z-10 group/connect w-full cursor-pointer focus:outline-none"
              tabIndex={0}
            >
              {/* Default border */}
              <div className="absolute inset-0 rounded-xl border border-white/10 group-hover/connect:opacity-0 group-focus/connect:opacity-0 transition-opacity duration-300" />
              
              {/* Animated gradient background */}
              <div className="absolute inset-0 rounded-xl bg-[linear-gradient(90deg,transparent,rgba(86,6,255,0.4),rgba(254,137,137,0.4),transparent)] bg-[length:200%_100%] animate-border-flow opacity-0 group-hover/connect:opacity-100 group-focus/connect:opacity-100 transition-opacity duration-500" />
              ...
              <div className="relative bg-zinc-900/60 backdrop-blur-md rounded-xl p-6 w-full shadow-xl">
                ...
                <div className="space-y-1 text-sm flex flex-col">
                  <a 
                    ...
                    className="flex items-center text-zinc-400 hover:text-white transition-colors p-2 rounded-lg hover:bg-white/5 group w-full"
                  >
                    <Mail className="w-5 h-5 mr-3 shrink-0 text-zinc-500 group-hover:text-[#fe8989] transition-colors" />
                    <span className="break-all">akshaybhat301094@gmail.com</span>
                  </a>
                  <a 
                    ...
                    className="flex items-center text-zinc-400 hover:text-white transition-colors p-2 rounded-lg hover:bg-white/5 group w-full"
                  >
                    <svg className="w-5 h-5 mr-3 shrink-0 text-zinc-500 group-hover:text-[#0077b5] transition-colors" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <a 
                    ...
                    className="flex items-center text-zinc-400 hover:text-white transition-colors p-2 rounded-lg hover:bg-white/5 group w-full"
                  >
                    <svg className="w-5 h-5 mr-3 shrink-0 text-zinc-500 group-hover:text-[#E1306C] transition-colors" fill="currentColor" viewBox="0 0 24 24">
          ...
          {/* Bio Content Section (Order 2 on Mobile) */}
          <div className="col-span-1 md:col-span-3 md:col-start-3 md:row-start-1 md:row-span-4 order-2 space-y-8 w-full">
            <div>
            ...
            <div 
              className="relative p-[1px] rounded-2xl transition-all duration-300 hover:-translate-y-1 focus:-translate-y-1 hover:shadow-[0_15px_40px_rgba(86,6,255,0.12)] focus:shadow-[0_15px_40px_rgba(86,6,255,0.12)] z-10 group/bio w-full cursor-pointer focus:outline-none animate-fade-up"
              style={{ animationDelay: '0.2s' }}
              tabIndex={0}
            >
              {/* Default border */}
              <div className="absolute inset-0 rounded-2xl border border-white/10 group-hover/bio:opacity-0 group-focus/bio:opacity-0 transition-opacity duration-300" />
              
              {/* Animated gradient background */}
              <div className="absolute inset-0 rounded-2xl bg-[linear-gradient(90deg,transparent,rgba(86,6,255,0.4),rgba(254,137,137,0.4),transparent)] bg-[length:200%_100%] animate-border-flow opacity-0 group-hover/bio:opacity-100 group-focus/bio:opacity-100 transition-opacity duration-500" />
              
              {/* Inner Card Content */}
              <div className="relative space-y-6 text-lg text-zinc-300 leading-relaxed bg-zinc-900/40 backdrop-blur-md p-8 rounded-2xl shadow-xl">
                <p>
